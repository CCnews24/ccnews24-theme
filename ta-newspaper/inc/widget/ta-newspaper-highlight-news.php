...
add_action('widgets_init', 'ta_newspaper_highlight_post_register');

function ta_newspaper_highlight_post_register() {
    register_widget('TA_Newspaper_Highlight_Posts_Widget');
}

class TA_Newspaper_Highlight_Posts_Widget extends WP_Widget {

    public function __construct() {
        parent::__construct(
                'TA_Newspaper_Highlight_Posts_Widget', esc_html__('TA : Home Highlight Posts', 'ta-newspaper'), array(
        ...
        <div class="blog-wrap">
            <div class="blog-contents">
                ...
                if( $ta_post_slide_layout == 'layout-3'){ ?>
                    ...
                    <div class="highlight-main-wrap-1 clearfix">
                        <div class="highlight-loop-wrap-1">
                            ...
                            while($tan_blog_query->have_posts()){
                                ...
                                if( $tan_count_post == 1 ){
                                    ...
                                    <div class='highlight-first-post'>
                                        <div class="tab-simple-highlight-list-1">
                                            <div class="tab-simple-highlight-1 clearfix">
                                                ...
                                                <div class="tab-sb-content-highlite">
                            ...
                            <div class="highlited-3-other clearfix">
                                <?php
                                $tan_count_post_1 = 1;
                                while( $tan_blog_query->have_posts() ){
                                    $tan_blog_query->the_post(); ?>

                                        <div class='highlight-other-post-3'>
                                            <?php 
                ...
                <?php }elseif( $ta_post_slide_layout == 'layout-2' ){ ?>
                    ...
                    <div class="highlight-main-wrap-2">
                        <div class="highlight-loop-wrap-2 clearfix">
                            <?php $tan_count_post_2 = 1;
                            
                            while($tan_blog_query->have_posts()){
                                    $tan_blog_query->the_post();

                                if( $tan_count_post_2 == 1 ){ ?>
                                    <div class='highlight-first-post-2'>
                                    
                                        <?php
                                        $tan_blog_image = wp_get_attachment_image_src(get_post_thumbnail_id(),'ta-newspaper-first-highlite-post-2');?>

                                        <div class="tab-simple-highlight-list-2">
                                            <div class="tab-simple-highlight-2 clearfix">
                                                <div class="tab-sb-image-2 ta-post-formate">
                                ...
                                <?php break; } ?>
                            <?php $tan_count_post_2 ++; } 
                            wp_reset_postdata(); ?>

                            <div class="other-highlight-posts">
                                <?php
                                while($tan_blog_query->have_posts()){
                                    $tan_blog_query->the_post(); ?>
                                        
                                        <?php
                                        $tan_blog_image = wp_get_attachment_image_src(get_post_thumbnail_id(),'ta-newspaper-first-multiple-cat-post');?>

                                        <div class="tab-simple-highlight-list-2">
                                            <div class="tab-simple-highlight-2 clearfix">
                                                <div class="tab-sb-image-2">
                ...
                <?php }else{ ?>
                    ...
                    <div class="highlight-main-wrap-1 clearfix">
                        <div class="highlight-loop-wrap-1">
                            <?php $tan_count_post_4 = 1;
                            
                            while($tan_blog_query->have_posts()){
                                    $tan_blog_query->the_post();

                                if( $tan_count_post_4 == 1 ){
                                    echo "<div class='highlight-first-post'>";
                                    $tan_blog_image = wp_get_attachment_image_src(get_post_thumbnail_id(),'ta-newspaper-single-page');
                                }else{
                                    echo "<div class='highlight-other-post'>";
                                    $tan_blog_image = wp_get_attachment_image_src(get_post_thumbnail_id(),'ta-newspaper-related-post');
                                } ?>
