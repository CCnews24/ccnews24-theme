...
function ta_newspaper_scripts1() {
	...
	wp_enqueue_style( 'ta-newspaper-carousel', get_stylesheet_directory_uri() . '/assets/css/slick.theme.css' );
	wp_enqueue_style( 'ta-newspaper-theme', get_stylesheet_directory_uri() . '/assets/css/slick.css' );
	...
	wp_enqueue_script( 'ta-newspaper-owl-carousel', get_stylesheet_directory_uri() . '/assets/js/slick.min.js', array(), '20151215', true );
